...
xst -ifn xst.scr
move cmos_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cmos_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmos_pll_exdes.ucf cmos_pll_exdes

echo 'Running map'
map -timing -pr b cmos_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm cmos_pll_exdes -w routed.ncd routed.v
cd ..
